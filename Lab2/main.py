...
times_invert = [0.0, 0.003, 0.017, 0.1366, 0.9335]
times_lu = [0.001, 0.002, 0.023, 0.1242, 0.7844]
times_det = [0.0, 0.002, 0.0339, 0.1192, 0.7844]
operations_invert = [286, 3074, 26446, 206114, 1529326]
operations_lu = [173, 2169, 20635, 170773, 1312323]
operations_det = [177, 2177, 20651, 170805, 1312387]
